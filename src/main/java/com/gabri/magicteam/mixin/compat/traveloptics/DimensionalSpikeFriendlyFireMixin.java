...
@Pseudo
@Mixin(targets = "com.gametechbc.traveloptics.entity.projectiles.dimensional_spike.DimensionalSpikeEntity", remap = false)
public abstract class DimensionalSpikeFriendlyFireMixin {
    @Redirect(
