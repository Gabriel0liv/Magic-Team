...
@Pseudo
@Mixin(targets = "com.gametechbc.traveloptics.entity.extended_projectiles.extended_wave.ReturningWaveEntity", remap = false)
public abstract class ReturningWaveFriendlyFireMixin {
    @Redirect(
            method = "modifiedAttackEntities()V",
