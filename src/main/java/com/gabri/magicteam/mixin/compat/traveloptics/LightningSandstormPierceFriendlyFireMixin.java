...
@Pseudo
@Mixin(targets = "com.gametechbc.traveloptics.entity.projectiles.lightning_sandstorm_projectile.LightningSandstormPierceProjectileEntity", remap = false)
public abstract class LightningSandstormPierceFriendlyFireMixin {
    @Redirect(
