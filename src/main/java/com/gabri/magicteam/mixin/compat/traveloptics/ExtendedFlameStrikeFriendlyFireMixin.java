...
@Pseudo
@Mixin(targets = "com.gametechbc.traveloptics.entity.extended_projectiles.ExtendedFlameStrikeEntity", remap = false)
public abstract class ExtendedFlameStrikeFriendlyFireMixin {
    @Redirect(
