...
@Pseudo
@Mixin(targets = "com.gametechbc.traveloptics.entity.extended_projectiles.ExtendedPhantomHalberdEntity", remap = false)
public abstract class ExtendedPhantomHalberdFriendlyFireMixin {
    @Redirect(
