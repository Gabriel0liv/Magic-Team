...
@Pseudo
@Mixin(targets = "com.gametechbc.traveloptics.entity.extended_projectiles.extended_wave.ExtendedWaveEntity", remap = false)
public abstract class ExtendedWaveFriendlyFireMixin {
    @Redirect(
