...
@Pseudo
@Mixin(targets = "com.gametechbc.traveloptics.entity.extended_projectiles.ExtendedStormSerpentEntity", remap = false)
public abstract class ExtendedStormSerpentFriendlyFireMixin {
    @Redirect(
            method = "triggerAOE()Z",
