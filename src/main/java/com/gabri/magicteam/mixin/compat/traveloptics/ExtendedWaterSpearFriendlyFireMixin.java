...
@Pseudo
@Mixin(targets = "com.gametechbc.traveloptics.entity.extended_projectiles.ExtendedWaterSpearEntity", remap = false)
public abstract class ExtendedWaterSpearFriendlyFireMixin {
    @Redirect(
