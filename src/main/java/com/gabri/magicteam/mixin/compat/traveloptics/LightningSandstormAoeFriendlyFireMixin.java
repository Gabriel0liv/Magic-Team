...
@Pseudo
@Mixin(targets = "com.gametechbc.traveloptics.entity.projectiles.lightning_sandstorm_projectile.LightningSandstormAoeProjectileEntity", remap = false)
public abstract class LightningSandstormAoeFriendlyFireMixin {
    @Redirect(
            method = "performAoEDamage()V",
