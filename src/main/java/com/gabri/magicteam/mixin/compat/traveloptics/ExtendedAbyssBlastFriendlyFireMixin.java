...
@Pseudo
@Mixin(targets = "com.gametechbc.traveloptics.entity.extended_projectiles.ExtendedAbyssBlastEntity", remap = false)
public abstract class ExtendedAbyssBlastFriendlyFireMixin {
    @Redirect(
            method = "m_8119_()V",
